# Satisfi Labs HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. Satisfi Labs helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of Satisfi Labs or our business and change to appropriate references to your company.
...
[Satisfi Labs](htts://datica.com), healthcare's trusted HITRUST CSF Certified digital health platform.
...
* [Satisfi Labs HIPAA Business Associate Agreement (“BAA”)](source/sections/23-datica_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to Satisfi Labs Controls](source/sections/24-hipaa_mapping_to_datica_controls.md)
